...
public class Vertical_ViewPager extends ViewPager implements NestedScrollingParent {
    ...
    public Vertical_ViewPager(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
