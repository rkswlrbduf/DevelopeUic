...
public class F1_Section3_RecyclerviewAdapter extends RecyclerView.Adapter<F1_Section3_RecyclerviewAdapter.MyViewHolder> {
    ...
    public F1_Section3_RecyclerviewAdapter(Context context, LayoutInflater inflater) {
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
        final View view = inflater.inflate(R.layout.f1_section3_recyclerview_row, parent, false);
                ...
                if (lp instanceof GridLayoutManager.LayoutParams) {
                    ...
                    switch (type) {
                        ...
                        case TYPE_RIGHT_THIRD:
                            ...
                            ((ImageView) view.findViewById(R.id.section3_image)).setLayoutParams(layoutParams1);
                            sglp.height += ((LinearLayout)view.findViewById(R.id.section3_container)).getHeight() + dipToPixels(context, 6);
                        ...
                        case TYPE_RIGHT_HALF:
                            ...
                            ((ImageView) view.findViewById(R.id.section3_image)).setLayoutParams(layoutParams2);
                            sglp.height += ((LinearLayout)view.findViewById(R.id.section3_container)).getHeight() + dipToPixels(context, 6);
                            view.setLayoutParams(sglp);
                            break;
                    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            image = (ImageView) itemView.findViewById(R.id.section3_image);
            name = (TextView) itemView.findViewById(R.id.section3_name);
            current_price = (TextView) itemView.findViewById(R.id.section3_current_price);
            before_price = (TextView) itemView.findViewById(R.id.section3_before_price);
        }
    }
}
