...
public class F0_S3_OldAdapter extends RecyclerView.Adapter<F0_S3_OldAdapter.MyViewHolder> {
    ...
    public F0_S3_OldAdapter(Context context, LayoutInflater inflater) {
