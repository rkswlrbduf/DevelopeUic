...
public class Horizontal_ViewPager extends ViewPager implements NestedScrollingParent {
    ...
    public Horizontal_ViewPager(Context context) {
        super(context);
    }

    public Horizontal_ViewPager(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
